...
plt.tight_layout()
plt.savefig('fusion_training_metrics.png')
plt.show()
...
plt.title('Confusion Matrix - Fusion Features')
...
plt.title('t-SNE Visualization - Fusion Features')
plt.savefig('fusion_tsne_visualization.png')
plt.show()
